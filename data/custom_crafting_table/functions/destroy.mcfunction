...
execute unless entity @p[gamemode=creative] run summon minecraft:item ~ ~-49 ~ {Item:{id:"minecraft:bat_spawn_egg",Count:1b,tag:{EntityTag:{CustomName:'{"text":"custom_craft"}',NoAI:1b},display:{Name:'{"translate":"ms.item:custom_crafting_table","italic":false}'},CustomModelData:32119}}}
kill @s[type=!player]