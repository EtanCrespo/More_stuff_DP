...
execute as @a unless entity @s[nbt={SelectedItem:{tag:{display:{Name:'{"translate":"ms.item:wrench","italic":false}'}}}}] at @s as @e[nbt={Tags:[invisible.frame]},distance=..9,sort=furthest] run data modify entity @s Invisible set value 1b
execute as @a unless entity @s[nbt={SelectedItem:{tag:{display:{Name:'{"translate":"ms.item:wrench","italic":false}'}}}}] at @s as @e[nbt={Tags:[invisible.frame]},distance=..9,sort=furthest] run data modify entity @s Glowing set value 0b
