...
execute as @e[type=item_display,nbt={item:{id:"minecraft:crafting_table",tag:{CustomModelData:32119}}}] at @s if block ~ ~-383 ~ barrel{Items:[{id:"minecraft:potion"},{id:"minecraft:paper"}]} run scoreboard players set @s craftID 1615
...
execute as @e[type=item_display,nbt={item:{id:"minecraft:crafting_table",tag:{CustomModelData:32119}}},scores={craftID=1615}] at @s unless block ~ ~-383 ~ barrel{Items:[{id:"minecraft:paper"},{id:"minecraft:potion"}]} run scoreboard players set @s craftID 0